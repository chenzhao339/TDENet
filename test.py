...
def parse_args():
    ...
    parser.add_argument('--load_dir', dest='load_dir',
                        help='directory to load models', default="models/meta/first",
                        type=str)
...
if __name__ == '__main__':
    ...
    normal_mean_class_attentions = None
    if args.meta_test:
        print('loading normal attentions!')
        normal_mean_class_attentions = pickle.load(open(
            os.path.join('attentions',
                         str(args.phase) + '_shots_' + str(args.shots) + '_normal_mean_class_attentions.pkl'),
            'rb'))
    ...
    for i in range(num_images):
        ...
        rois_label, cls_prob_list, bbox_pred_list, _ = fasterRCNN(im_data_list, im_info_list, gt_boxes_list,
                                                                  num_boxes_list,mean_class_attentions=mean_class_attentions,normal_mean_class_attentions=normal_mean_class_attentions)
        if args.meta_test:
        ...
        if vis:
            im_dir = 'vis/' + str(data[4].numpy()[0]) + '_tdenet.png'
